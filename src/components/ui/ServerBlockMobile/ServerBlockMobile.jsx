    ...
    return (
        ...
        >
            <button
                ...
                onClick={() => navigate("/server/1")} className={`w-full p-3.5 flex flex-col gap-4 rounded-2xl bg-[#2B2D2C] duration-150 ${isTouched ? "scale-90" : ""}`} onTouchStart={() => setIsTouched(true)} onTouchEnd={() => setIsTouched(false)}>

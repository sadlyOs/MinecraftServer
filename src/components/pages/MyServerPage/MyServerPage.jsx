      ...
      <div className="server-hero py-20 container md:px-4 mx-auto text-white">
        <div className="w-full server__wrapper">
          ...
          >
            <div className="relative w-full pb-2">
              <img
                ...
                src={server.address.updated ? serverImg : noImg}
                alt="serverImg"
              />
            </div>
          ...
          >
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-3">
                <button onClick={() => navigate(`/serverPromotion/${id}`)} className="w-full bg-[#00D0FF40] md:rounded-full flex justify-center gap-3 py-3 cursor-pointer">
                ...
                <button className="w-full bg-[#FF030240] md:rounded-full flex justify-center gap-3 py-3 cursor-pointer">
          ...
          >
              ...
              <div>
                <div className="px-4">
                  ...
                  <m.p
                    ...
                    className="left"
                  >
                    Наш сервер - это настоящая революция в мире
                    майнкрафт-выживания, здесь вы найдете множество интересных
                ...
                <div className="px-4">
                  <p className="text-gray-main">
                    На нашем сервере каждый игрок сможет найти себе занятие по
                    душе.
                  </p>
                </div>
                    ...
                    <div className="flex md:grid md:grid-cols-4 gap-5 overflow-x-scroll md:overflow-hidden">
                      {[img1, img2, img3, img4].map((img, index) => (
                        <m.img
                          ...
                          viewport={{ once: true }}
                          className="w-full first:ml-5 md:first:ml-0"
                          src={img}
                          alt="img"
                        />
                      ))}
            ...
            {server.address.updated == null &&
            (
                <div className="px-4 h-100 flex flex-col justify-center text-center gap-2">
                    <p className="text-white">Пусто</p>
                    <p className="text-gray-main">На данный момент вы еще не<br />добавили описание проекта</p>
                </div>
            )}
            <div className="px-4">
              <div className="pb-3">
                ...
                <p className="text-gray-main">
                  FunParty - боссы мебель крафты 1.21.4
                </p>
              </div>
              <div className="w-full">
                <Line

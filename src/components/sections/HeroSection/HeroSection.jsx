        ...
        <section id="#home" className="relative top-[-64px] containerw-full h-screen bg-[url('@assets/hero/hero.png')] bg-cover">
            <div className="text-white px-4 w-full h-full flex justify-center items-center bg-black-transparent">
                <div className="text-center">
                    ...
                    <p className="text-[0.6rem] md:text-[1.2rem]">Лучший рейтинг и мониторинг Майнкрафт-серверов в России.<br />Ищи топовые сервера с мини-играми, модами и плагинами,<br /> читай отзывы и следи за онлайном.</p>
                </div>
            </div>
        </section>
    )
